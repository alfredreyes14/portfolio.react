        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <AboutItem label="Experience" value={`${profileSnapshot.yearsOfExperience} years`} />
